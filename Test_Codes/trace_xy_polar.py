"""
Live Polar XY Trace & Jump Diagnostics
Shows raw X, raw Y, center-adjusted X, Y, and instantaneous angle to pinpoint any jumps.
"""
...
def trace():
    print("\n============================================================")
    print(" 🧭 LIVE POLAR XY TRACER & ANGLE JUMP DIAGNOSTIC")
    print("============================================================")
    ...
    # Init continuous mode (0x0D = ±30G, 200Hz ODR, 512 OSR)
    ...
    print("👉 HOLD BOARD IN AIR AND ROTATE SLOWLY 360 DEGREES...\n")
