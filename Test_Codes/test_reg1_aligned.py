"""
QMC6310 EXACT ALIGNMENT TEST (Reg 0x01..0x06)
Reading from register 0x01 with signed little-endian (<hhh)
"""
...
def test():
    print("\n============================================================")
    print(" 🎯 QMC6310 CORRECTED REGISTER ALIGNMENT (Reg 0x01..0x06)")
    print("============================================================")
    ...
    while True:
        try:
            # Read 6 bytes starting from Register 0x01 (X_L, X_M, Y_L, Y_M, Z_L, Z_M)
